...
const TaskDetails = () => {
  ...
  const { data: taskResponse, isLoading } = useGetTaskQuery(id);
  ...
  return isLoading ? (
    ...
    <div className='py-10 text-center text-gray-500'>Task not found.</div>
  ) : (
            ...
            <div className='w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-white shadow-md p-8 overflow-y-auto'>
                ...
                <div className='space-y-4 py-6'>
                  ...
                  <div className='space-y-8'>
                    {task?.subTasks?.length > 0 ? (
                      ...
                      <p className='text-gray-400'>No sub-tasks yet.</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className='w-full md:w-1/2 space-y-8'>
                ...
                {task?.assets?.length > 0 ? (
                  ...
                  <p className='text-gray-400'>No assets attached.</p>
                )}
              </div>
            </div>
          </>
