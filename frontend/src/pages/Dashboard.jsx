...
// Normalize whatever the backend sends ("To Do", "TODO", "to do") into one key
...
const PRIORITY_COLORS = {
  ...
  low: "text-green-600",
  ...PRIOTITYSTYELS, // let your existing utils override if it defines these
};
...
const Dashboard = () => {
  ...
  // Stage totals (todo / in progress / completed), normalized
  ...
  return (
    <div className="h-full py-4">
      ...
      <div className="w-full flex flex-col md:flex-row gap-4 2xl:gap-10 py-8">
        {tasks.length === 0 ? (
          <p className="text-gray-500">No tasks yet. Create one to see it here.</p>
        ) : (
          <>
